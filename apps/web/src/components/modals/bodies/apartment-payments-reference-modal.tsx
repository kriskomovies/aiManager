...
import { ApartmentFeesReferenceTable } from '@/components/cashier/apartment-fees-and-payments-reference-table';

export function ApartmentPaymentsReferenceModal() {
    ...
    >
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-200">
        <h2 className="text-xl font-semibold text-gray-900">
          Справка Плащания за Апартамент {apartmentNumber}
        </h2>
        <button
          onClick={handleClose}
      ...
      <div className="p-6 max-h-[calc(90vh-140px)] overflow-auto">
        <ApartmentFeesReferenceTable hideOldDebtsColumn={true} />
      </div>
