...
export function DeleteApartmentIrregularityModal({ onClose }: DeleteApartmentIrregularityModalProps) {
  ...
  const irregularityTitle = modalData?.irregularityTitle || 'Неизвестна нередност';
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.log('Deleting irregularity:', irregularityId, 'for apartment:', apartmentId);
      ...
      let errorMessage = 'Възникна грешка при изтриването на нередността. Моля опитайте отново.';
