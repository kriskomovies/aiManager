...
export const addApartmentSchema = z.object({
  ...
  quadrature: z.coerce.number().min(0.1, 'Квадратурата трябва да е положително число'),
  commonParts: z.coerce.number().min(0, 'Общите части трябва да са положително число').optional(),
  idealParts: z.coerce.number().min(0, 'Идеалните части трябва да са положително число').optional(),
  
  // Residents Information
  residentsCount: z.coerce.number().min(0, 'Броят живущи трябва да е положително число'),
  pets: z.coerce.number().min(0, 'Броят домашни любимци трябва да е положително число'),
  ...
  monthlyRent: z.coerce.number().min(0, 'Месечната наемна цена трябва да е положително число').optional(),
  maintenanceFee: z.coerce.number().min(0, 'Таксата поддръжка трябва да е положително число').optional(),
